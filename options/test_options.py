...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--shape', type=str, default='examples/cari_seg/val/Jackie Chan_C00001.png', help='shape image name')
        parser.add_argument('--style_path', type=str, default='examples/style_imgs/ko.jpg', help='style image path')
